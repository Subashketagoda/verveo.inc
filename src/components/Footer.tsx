...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-gradient-to-b from-[#4C1D95] via-[#3B0764] to-[#2E0854] text-[#EDE9FE]/80 border-t border-[#A78BFA]/30 pt-16 sm:pt-20 pb-12 px-4 sm:px-10 lg:px-16 overflow-hidden">
      <div className="w-full max-w-7xl mx-auto space-y-16">
        {/* Top Footer Navigation Grid */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 border-b border-[#A78BFA]/20 pb-16">
          {/* Brand Info */}
          <div className="md:col-span-5 space-y-5">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="font-display text-lg font-black tracking-[0.2em] text-[#FFFFFF] flex items-center">
                VERVEO
                <span className="text-xs text-[#DDD6FE] ml-0.5 font-sans font-normal">®</span>
              </span>
            </Link>

            <p className="font-grotesk text-xs tracking-wider text-[#DDD6FE] uppercase font-bold">
              Creative Marketing Agency
            </p>

            <p className="text-sm text-[#EDE9FE]/80 font-sans font-normal leading-relaxed max-w-sm">
            ...
            {/* Live Studio Clock */}
            <div className="flex items-center gap-3 font-mono text-xs text-[#EDE9FE]/80 border-l-2 border-[#DDD6FE] pl-3 py-0.5">
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs font-grotesk">
              <li>
                ...
                >
                  <InstagramIcon className="h-3.5 w-3.5 text-[#DDD6FE]" />
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 hover:text-white transition-colors"
                >
                  <Mail className="h-3.5 w-3.5 text-[#DDD6FE]" />
          ...
          <div className="md:col-span-2 flex flex-col justify-between items-start md:items-end">
            <button
              onClick={scrollToTop}
              className="group flex items-center gap-2 rounded-full border border-[#A78BFA]/30 bg-[#3B0764] px-4 py-2.5 text-xs font-grotesk text-[#EDE9FE] hover:bg-[#7C3AED] hover:text-white transition-colors"
            >
              <span>BACK TO TOP</span>
              <ArrowUp className="h-3.5 w-3.5 group-hover:-translate-y-1 transition-transform" />
            </button>

            <span className="text-[11px] font-mono text-[#EDE9FE]/40 hidden md:inline">
              VERVEO CREATIVE INC.
            </span>
          </div>
        </div>
        ...
        <div className="relative select-none text-center overflow-hidden py-8">
          <div className="font-display text-5xl sm:text-7xl md:text-8xl lg:text-[9.5rem] font-black tracking-tight text-[#7C3AED]/20 leading-none whitespace-nowrap">
            BUILT TO BE SEEN.
          </div>
        </div>

        {/* Bottom Legal & Copyright Bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-grotesk text-[#EDE9FE]/60">
          <div>
