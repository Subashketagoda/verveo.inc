      ...
      <div className="pt-32 sm:pt-44 pb-20 sm:pb-24 px-4 sm:px-10 lg:px-16 max-w-7xl mx-auto w-full space-y-16 sm:space-y-32">
        ...
        <div className="space-y-6 sm:space-y-8 max-w-6xl">
          <div className="flex items-center gap-3">
            <span className="font-mono text-xs text-[#DDD6FE] font-bold">MANIFESTO // 03</span>
          ...
          <p className="max-w-2xl text-base sm:text-2xl font-sans text-[#F8F7F3]/85 font-normal leading-relaxed pt-2 sm:pt-4">
        ...
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#6D28D9] via-[#4C1D95] to-[#3B0764] p-8 sm:p-14 shadow-2xl border border-[#A78BFA]/30 text-white backdrop-blur-md">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 space-y-6">
              <span className="inline-block rounded-full bg-[#3B0764]/70 border border-[#A78BFA]/30 px-3.5 py-1 text-xs font-mono text-[#DDD6FE] tracking-widest uppercase backdrop-blur-md">
                BRAND PHILOSOPHY
              </span>
              ...
              <p className="text-base text-[#F8F7F3]/90 font-sans font-normal leading-relaxed max-w-xl">
            ...
            <div className="lg:col-span-5 relative aspect-4/3 rounded-2xl overflow-hidden border border-[#A78BFA]/30 shadow-2xl">
              <Image
              ...
              <div className="absolute bottom-3 left-3 text-[11px] font-mono text-[#DDD6FE]">
        ...
        <div className="space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between border-b border-[#A78BFA]/20 pb-6 gap-4">
            <div>
            ...
            <span className="text-xs font-mono text-[#F8F7F3]/80">
              SELECT PILLAR TO EXPLORE
            </span>
          </div>

          {/* Interactive Pillar Selector Strip */}
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 p-1.5 rounded-2xl border border-[#A78BFA]/30 bg-[#4C1D95]/80 backdrop-blur-md">
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 rounded-xl py-3 px-3 text-xs font-grotesk font-bold tracking-wider transition-all duration-300 ${
                  activePillar.id === p.id
                    ? "bg-white text-[#5B21B6] shadow-[0_0_20px_rgba(255,255,255,0.4)] scale-100"
          ...
          {/* Active Pillar Card */}
          <div className="rounded-3xl border border-[#A78BFA]/30 bg-[#4C1D95]/90 p-6 sm:p-10 shadow-lg backdrop-blur-md">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6 relative aspect-16/10 rounded-2xl overflow-hidden border border-[#A78BFA]/30 bg-[#3B0764]">
                <Image
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <span className="font-mono text-xs text-[#DDD6FE] font-bold tracking-widest">
              ...
              <div className="lg:col-span-6 space-y-4">
                ...
                <p className="text-base text-[#F8F7F3]/90 font-sans font-normal leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-[#A78BFA]/20 pt-16 items-center">
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="space-y-4 text-[#F8F7F3]/80 font-sans font-normal leading-relaxed text-sm sm:text-base">
              <p>
              ...
              <p>
                Our work is fast, cinematic, and tuned to the visual frequency of modern audiences. Alongside our commercial division, our sister brand <span className="text-[#DDD6FE] font-semibold">@verveo_weddings</span> brings 35mm optical elegance to matrimonial celebrations worldwide.
              </p>
            </div>
            ...
            <div className="pt-2">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 font-grotesk text-xs font-bold tracking-wider text-[#5B21B6] shadow-[0_0_25px_rgba(255,255,255,0.4)] hover:bg-[#DDD6FE] hover:scale-105 transition-all"
              >
          ...
          <div className="lg:col-span-6 grid grid-cols-2 gap-4">
            <div className="relative aspect-3/4 rounded-2xl overflow-hidden border border-[#A78BFA]/30 bg-[#4C1D95]">
              <Image
            ...
            <div className="relative aspect-3/4 rounded-2xl overflow-hidden border border-[#A78BFA]/30 bg-[#4C1D95] mt-8">
              <Image
